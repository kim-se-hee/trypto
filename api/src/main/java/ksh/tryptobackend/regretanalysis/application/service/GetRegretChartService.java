...
public class GetRegretChartService implements GetRegretChartUseCase {
    ...
    public RegretChartResult getRegretChart(GetRegretChartQuery query) {
        ...
        List<DailyComparison> assetHistory =
                mapToAssetHistory(timeline, lossTimeline, btcBenchmark);
    ...
    private void validateReportExists(GetRegretChartQuery query) {
        if (!regretReportQueryPort.existsByRoundIdAndExchangeId(
    ...
    private AssetTimeline getAssetTimeline(GetRegretChartQuery query) {
        List<AssetSnapshot> snapshots =
                findSnapshotsUseCase
                        .findAllByRoundIdAndExchangeId(query.roundId(), query.exchangeId())
                        .stream()
    ...
    private List<DailyComparison> mapToAssetHistory(
    ...
    private List<ViolationMarkerPoint> mapToViolationMarkerPoints(
