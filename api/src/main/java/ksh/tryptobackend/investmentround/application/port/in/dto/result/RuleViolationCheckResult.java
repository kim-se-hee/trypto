...
public record RuleViolationCheckResult(Long ruleId, String violationReason, LocalDateTime createdAt) {
    ...
    public static RuleViolationCheckResult from(DetectedViolation violation) {
        return new RuleViolationCheckResult(violation.ruleId(), violation.violationReason(), violation.createdAt());
    }
}
