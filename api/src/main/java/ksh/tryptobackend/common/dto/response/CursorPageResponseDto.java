...
public record CursorPageResponseDto<T>(List<T> content, Long nextCursor, boolean hasNext) {
    ...
    public static <E, T> CursorPageResponseDto<T> fromPage(
            List<E> fetchedItems, int requestedSize, Function<E, T> mapper, Function<E, Long> cursorExtractor) {
