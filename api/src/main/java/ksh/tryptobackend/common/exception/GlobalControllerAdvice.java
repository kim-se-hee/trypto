...
public class GlobalControllerAdvice {
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleCustomException(CustomException e) {
        ...
        String message =
                messageSource.getMessage(
                        errorCode.getMessageKey(), e.getArgs().toArray(), Locale.getDefault());

        ApiResponseDto<Void> response =
                ApiResponseDto.of(errorCode.getStatus(), errorCode.name(), message, null);
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleValidationException(
        ...
        ApiResponseDto<Void> response =
                ApiResponseDto.of(
                        HttpStatus.BAD_REQUEST.value(), "VALIDATION_ERROR", message, null);
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleDataIntegrityViolation(
        ...
        String message =
                messageSource.getMessage(
                        ErrorCode.DUPLICATE_REQUEST.getMessageKey(), null, Locale.getDefault());
