...
public record RankingItemResponse(int rank, Long userId, String nickname, BigDecimal profitRate, int tradeCount) {

    public static RankingItemResponse from(RankingItemResult result) {
        return new RankingItemResponse(
                result.rank(), result.userId(), result.nickname(), result.profitRate(), result.tradeCount());
    }
}
