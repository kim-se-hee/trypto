...
class HoldingTest {
    ...
    class ApplyBuyTest {
        ...
        void applyBuy_firstBuy_avgPriceEqualsFilledPrice() {
            ...
            holding.applyBuy(
                    new BigDecimal("50000000"), new BigDecimal("0.01"), new BigDecimal("50000000"));
        ...
        void applyBuy_additionalBuy_weightedAveragePrice() {
            ...
            holding.applyBuy(
                    new BigDecimal("40000000"), new BigDecimal("0.01"), new BigDecimal("40000000"));
        ...
        void applyBuy_atProfit_averagingDownCountUnchanged() {
            ...
            holding.applyBuy(
                    new BigDecimal("60000000"), new BigDecimal("0.01"), new BigDecimal("60000000"));
